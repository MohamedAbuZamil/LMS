  ...
  return (
    <main className="bg-slate-50/40">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-brand-100/70 via-brand-50/40 to-transparent">
        ...
        <div className="pointer-events-none absolute bottom-10 left-10 w-24 h-24 dots opacity-30" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            >
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold leading-tight text-ink-900">
                إنشاء <span className="gradient-text">حساب طالب</span>
              </h1>
              <p className="mt-4 text-sm sm:text-base text-ink-600">
                أنشئ حسابك الآن وابدأ رحلتك التعليمية معنا
              </p>
              <motion.span
                initial={{ width: 0 }}
                animate={{ width: 72 }}
      ...
      {/* Form card */}
      <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 -mt-6 relative z-10 pb-12">
        <SignupForm />
      </section>
